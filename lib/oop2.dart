...
void main() {
  ...
  print(razanHome.rooms.length); // عدد الغرف  0 , 1 ,2
   ...
   for (int index = 0; index < razanHome.rooms.length; index++) {
    ...
    print("Room Number ${index + 1} Door (Height,Width) ${razanHome.rooms[index].door.height} ,${razanHome.rooms[index].door.width}");
    ...
    print('\n'); }
   //output
  //Room number 1  Area : 25.0
  // Room Number 1 Door (Height,Width) 100.0 ,100.0
  // Room Number 1 Window Width 100.0
  // Room Number 1 Window height 100.0
  //
  //
  // Room number 2  Area : 200.0
  // Room Number 2 Door (Height,Width) 150.0 ,150.0
  // Room Number 2 Window Width 100.0
  // Room Number 2 Window height 100.0
  // Room Number 2 Window Width 600.0
  // Room Number 2 Window height 600.0
  ...
  // 1
  // 3
  // [Instance of 'Room', Instance of 'Room', Instance of 'Room']
